(function (){
    ...
    function init()
    {
        ...
        var theader = $("#movie-header"); //table.find("header");
        var tbody = $("#movie-container"); //table.find("tbody");
        ...
        function searchMovieByCompany()
        {
            ...
            //$http.get("url").success(function(res){/*do something with response data. */});
        }
        ...
        function renderMoviesWithTemplate(response)
        {
            ...
            theader.empty();
            var tr = $("<tr>");
            var titleTd  = $("<th>Title</th>");
            var yearTd  = $("<th>Plot</th>");
            var remarkTd  = $("<th>Poster</th>");
            tr.append(titleTd);
            tr.append(yearTd);
            tr.append(remarkTd);
            theader.append(tr);
       ...
       /* $.ajax({
        ...
        function renderMovies(result)
        {
            ...
            var tr = $("<tr>");
            var titleTd  = $("<th>Title</th>");
            var yearTd  = $("<th>Year</th>");
            var remarkTd  = $("<th>Remark</th>");
            tr.append(titleTd);
            tr.append(yearTd);
            tr.append(remarkTd);
            theader.append(tr);
